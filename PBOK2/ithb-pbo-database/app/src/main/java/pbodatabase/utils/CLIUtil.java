package pbodatabase.utils;

import java.util.Scanner;

import pbodatabase.exceptions.EmptyInputException;
import pbodatabase.exceptions.InvalidNumberException;
...
public class CLIUtil {
    ...
    public static String getString(String prompt) throws EmptyInputException {
        ...
        if (input.trim().isEmpty()) {
            throw new EmptyInputException("Input ga boleh kosong... coba lagi.");
        }
        return input;
    }
